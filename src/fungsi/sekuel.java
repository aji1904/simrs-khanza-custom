...
public final class sekuel {
    ...
    public boolean mengedittf2(String table,String acuan_field, String acuan_field2,String update){
        bool=true;
        try {
            ps=connect.prepareStatement("update "+table+" set "+update+" where "+acuan_field+" and "+acuan_field2);
            try{                        
                ps.executeUpdate();  
                bool=true;
             }catch(Exception e){
    ...
    public boolean mengedittf2(String table,String acuan_field,String acuan_field2,String update,int i,String[] a){
        bool=true;
        try {
            ps=connect.prepareStatement("update "+table+" set "+update+" where "+acuan_field+" and "+acuan_field2);
            try{
