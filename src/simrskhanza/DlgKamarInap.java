...
import surat.SuratKeteranganIsolasi;
...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnKeteranganIsolasi = new javax.swing.JMenuItem();
        ...
        MnStatusAPD = new javax.swing.JMenuItem();
        ...
        ppSkriningGizi.setPreferredSize(new java.awt.Dimension(150, 26));
        ...
        ppAsuhanGizi.setPreferredSize(new java.awt.Dimension(150, 26));
        ...
        ppMonitoringAsuhanGizi.setPreferredSize(new java.awt.Dimension(150, 26));
        ...
        MnPeniliaianAwalKeperawatanKebidanan.setText("Penilaian Awal Kebidanan & Kandungan");
        ...
        MnPeniliaianAwalKeperawatanKebidanan.setPreferredSize(new java.awt.Dimension(260, 26));
        ...
        ppResume.setPreferredSize(new java.awt.Dimension(150, 26));
        ...
        MnDiagnosa.setPreferredSize(new java.awt.Dimension(150, 26));
        ...
        MnHemodialisa.setPreferredSize(new java.awt.Dimension(150, 26));
        ...
        MnKeteranganIsolasi.setBackground(new java.awt.Color(255, 255, 254));
        MnKeteranganIsolasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKeteranganIsolasi.setForeground(new java.awt.Color(50, 50, 50));
        MnKeteranganIsolasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnKeteranganIsolasi.setText("Surat Keterangan Isolasi");
        MnKeteranganIsolasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnKeteranganIsolasi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnKeteranganIsolasi.setName("MnKeteranganIsolasi"); // NOI18N
        MnKeteranganIsolasi.setPreferredSize(new java.awt.Dimension(210, 26));
        MnKeteranganIsolasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKeteranganIsolasiActionPerformed(evt);
            }
        });
        MnLaporan.add(MnKeteranganIsolasi);
        ...
        MnStatusAPD.setBackground(new java.awt.Color(255, 255, 254));
        MnStatusAPD.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnStatusAPD.setForeground(new java.awt.Color(50, 50, 50));
        MnStatusAPD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnStatusAPD.setText("Atas Persetujuan Dokter");
        MnStatusAPD.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnStatusAPD.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnStatusAPD.setName("MnStatusAPD"); // NOI18N
        MnStatusAPD.setPreferredSize(new java.awt.Dimension(170, 26));
        MnStatusAPD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnStatusAPDActionPerformed(evt);
            }
        });
        SetStatus.add(MnStatusAPD);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2021" }));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2021" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-08-2021" }));
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbKamIn.getSelectedRow()>-1){
                if(norawat.getText().trim().equals("")){
                    ...
                    Sequel.mengedit("kamar_inap","no_rawat='"+norawat.getText()+"' and kd_kamar='"+kdkamar.getText()+"' and tgl_masuk='"+TIn.getText()+"' and jam_masuk='"+JamMasuk.getText()+"'","stts_pulang='Atas Permintaan Sendiri'");
                    Sequel.mengedit("kamar","kd_kamar='"+tbKamIn.getValueAt(tbKamIn.getSelectedRow(),19).toString()+"'","status='KOSONG'");  
                    tampil();
                }  
            }
...
//                    tampil();
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(tbKamIn.getSelectedRow()>-1){
                if(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),0).toString().equals("")){
                    try {
                        ...
                        try {
                              ...
                              if(rs2.next()){
                                    ...
                                    param.put("kontakrs",akses.getkontakrs());
                                    param.put("emailrs",akses.getemailrs());
                                    param.put("dpjp",Sequel.cariIsi("select dokter.nm_dokter from dokter JOIN dpjp_ranap ON dpjp_ranap.kd_dokter = dokter.kd_dokter where dpjp_ranap.no_rawat=?",rs2.getString("no_rawat2")));
                                    param.put("kamar",Sequel.cariIsi("select nm_bangsal from bangsal join kamar on bangsal.kd_bangsal=kamar.kd_bangsal join kamar_inap on kamar_inap.kd_kamar=kamar.kd_kamar WHERE kamar_inap.no_rawat=?",rs2.getString("no_rawat2")));
                                    param.put("pnj",Sequel.cariIsi("select penjab.png_jawab from penjab JOIN reg_periksa ON reg_periksa.kd_pj = penjab.kd_pj WHERE reg_periksa.no_rawat =?",rs2.getString("no_rawat2")));
                                    param.put("kelas_kamar",Sequel.cariIsi("select kelas from kamar join kamar_inap on kamar_inap.kd_kamar=kamar.kd_kamar WHERE kamar_inap.no_rawat =?",rs2.getString("no_rawat2")));
                                    
                                    Valid.MyReportqry("rptBarcodeRawatInap.jasper","report","::[ Barcode No.Rawat ]::",
                    ...
                    param.put("kontakrs",akses.getkontakrs());
                    param.put("emailrs",akses.getemailrs());
                    param.put("dpjp",Sequel.cariIsi("select dokter.nm_dokter from dokter JOIN dpjp_ranap ON dpjp_ranap.kd_dokter = dokter.kd_dokter where dpjp_ranap.no_rawat=?",norawat.getText()));
                    param.put("kamar",Sequel.cariIsi("select nm_bangsal from bangsal join kamar on bangsal.kd_bangsal=kamar.kd_bangsal join kamar_inap on kamar_inap.kd_kamar=kamar.kd_kamar WHERE kamar_inap.no_rawat=?",norawat.getText()));
                    param.put("jk",Sequel.cariIsi("select jk from pasien where no_rkm_medis =?",TNoRM.getText()));
                    param.put("pnj",Sequel.cariIsi("select penjab.png_jawab from penjab JOIN reg_periksa ON reg_periksa.kd_pj = penjab.kd_pj WHERE reg_periksa.no_rawat =?",norawat.getText()));
                    param.put("kelas_kamar",Sequel.cariIsi("select kelas from kamar join kamar_inap on kamar_inap.kd_kamar=kamar.kd_kamar WHERE kamar_inap.no_rawat =?",norawat.getText()));
                    ...
                    try {
                        ...
                        try {
                              ...
                              if(rs2.next()){
                                    ...
                                    Valid.MyReportqry("rptBarcodeRawatInap2.jasper","report","::[ Barcode No.Rawat ]::",
                                        "select reg_periksa.no_rawat from reg_periksa where no_rawat='"+rs2.getString("no_rawat2")+"'",param);
                                    this.setCursor(Cursor.getDefaultCursor());
                              }else{
                                  JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
    ...
    private void ppSuratPRIBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppSuratPRIBtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbKamIn.getSelectedRow()!= -1){
                try {
                    ps=koneksi.prepareStatement("select no_peserta,nm_pasien,tgl_lahir,jk from pasien where no_rkm_medis=?");
                    try {
                        ...
                        if(rs.next()){
                            if(rs.getString("no_peserta").length()<13){
                                ...
                                form.setNoRm(TNoRw1.getText(),rs.getString("no_peserta"),TNoRM.getText(),rs.getString("nm_pasien"),rs.getString("tgl_lahir"),rs.getString("jk"));
                                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                                form.setLocationRelativeTo(internalFrame1);
                                form.setVisible(true);
                                this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnKeteranganIsolasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKeteranganIsolasiActionPerformed
        // TODO add your handling code here:
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
            ...
            try {
                    ps=koneksi.prepareStatement("select reg_periksa.kd_dokter, dokter.nm_dokter from dpjp_ranap join reg_periksa on dpjp_ranap.no_rawat=reg_periksa.no_rawat join dokter on dpjp_ranap.kd_dokter=dokter.kd_dokter where reg_periksa.no_rawat =?");
                    try {
                        ...
                        if(!rs.isBeforeFirst() && rs.getRow() == 0){
                            ...
                            if(tbKamIn.getSelectedRow()!= -1){
                                ...
                                surat.isCek();
                                surat.emptTeks();
                                surat.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                                surat.setLocationRelativeTo(internalFrame1);
                                surat.setNoRm(TNoRw1.getText(),DTPCari1.getDate(),rs.getString("kd_dokter"),rs.getString("nm_dokter"));
                                surat.tampil();
    ...
    }//GEN-LAST:event_MnKeteranganIsolasiActionPerformed

    private void MnStatusAPDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnStatusAPDActionPerformed
        // TODO add your handling code here:
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
            ...
            if(tbKamIn.getSelectedRow()>-1){
                if(norawat.getText().trim().equals("")){
                    ...
                    Sequel.mengedit("kamar_inap","no_rawat='"+norawat.getText()+"' and kd_kamar='"+kdkamar.getText()+"' and tgl_masuk='"+TIn.getText()+"' and jam_masuk='"+JamMasuk.getText()+"'","stts_pulang='Atas Persetujuan Dokter'");
                    Sequel.mengedit("kamar","kd_kamar='"+tbKamIn.getValueAt(tbKamIn.getSelectedRow(),19).toString()+"'","status='KOSONG'");  
                    tampil();
                }  
            }
        }
    }//GEN-LAST:event_MnStatusAPDActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnKeteranganIsolasi;
    ...
    private javax.swing.JMenuItem MnStatusAPD;
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
               ...
               "penjab.png_jawab,concat(bangsal.nm_bangsal,' (',kamar.kelas,')') as kamar,kamar_inap.trf_kamar,kamar_inap.diagnosa_awal,kamar_inap.diagnosa_akhir," +
