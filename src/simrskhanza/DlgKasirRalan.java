...
import surat.SuratKeteranganAntigen;
...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakSuratAntigen = new javax.swing.JMenuItem();
        ...
        MnPeniliaianAwalKeperawatanBayiAnak.setPreferredSize(new java.awt.Dimension(260, 26));
        ...
        MnCetakSuratCovid.setText("Surat Keterangan Rapid Test");
        ...
        MnCetakSuratAntigen.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakSuratAntigen.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratAntigen.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratAntigen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratAntigen.setText("Surat Keterangan Antigen");
        MnCetakSuratAntigen.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCetakSuratAntigen.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCetakSuratAntigen.setName("MnCetakSuratAntigen"); // NOI18N
        MnCetakSuratAntigen.setPreferredSize(new java.awt.Dimension(250, 26));
        MnCetakSuratAntigen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratAntigenActionPerformed(evt);
            }
        });
        jMenu4.add(MnCetakSuratAntigen);
        ...
        MnCetakSuratKematian.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratKematian.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratKematian.setText("Surat Kematian");
        MnCetakSuratKematian.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCetakSuratKematian.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCetakSuratKematian.setName("MnCetakSuratKematian"); // NOI18N
        MnCetakSuratKematian.setPreferredSize(new java.awt.Dimension(250, 26));
        MnCetakSuratKematian.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratKematianActionPerformed(evt);
            }
        });
        jMenu4.add(MnCetakSuratKematian);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2021" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2021" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2021" }));
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnBarcodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBarcodeActionPerformed
        if(!TPasien.getText().equals("")){
            ...
            param.put("dpjp",Sequel.cariIsi("select dokter.nm_dokter from dokter JOIN reg_periksa ON reg_periksa.kd_dokter=dokter.kd_dokter where no_rawat=?",TNoRw.getText()));
            param.put("poli",Sequel.cariIsi("select poliklinik.nm_poli from poliklinik JOIN reg_periksa ON reg_periksa.kd_poli=poliklinik.kd_poli where no_rawat=?",TNoRw.getText()));
            param.put("jk",Sequel.cariIsi("select jk from pasien where no_rkm_medis =?",TNoRM.getText()));
            param.put("pnj",Sequel.cariIsi("select penjab.png_jawab from penjab JOIN reg_periksa ON reg_periksa.kd_pj = penjab.kd_pj WHERE reg_periksa.no_rawat =?",TNoRw.getText()));
    ...
    private void MnBuktiPelayananRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBuktiPelayananRalanActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            Valid.MyReportqry("rptBuktiPelayananRalan.jasper","report","::[ Surat Jaminan & Bukti Pelayanan Rawat Jalan ]::",
                "select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi, reg_periksa.jam_reg, reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,poliklinik.nm_poli, reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg, reg_periksa.stts_daftar,penjab.png_jawab,pasien.no_peserta,pasien.tgl_lahir, bridging_sep.no_sep, bridging_sep.nmppkrujukan as faskes from reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab on reg_periksa.kd_dokter=dokter.kd_dokter join bridging_sep on bridging_sep.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli where reg_periksa.no_rawat='"+TNoRw.getText()+"' ",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
                ...
                try {
                    ...
                    try {
                        ...
                        if(rskasir.next()){
                            ...
                            form.setNoRm(rskasir.getString("no_rawat"),rskasir.getString("no_sep"),rskasir.getString("no_kartu"),rskasir.getString("nomr"),rskasir.getString("nama_pasien"),rskasir.getString("tanggal_lahir"),rskasir.getString("jkel"),rskasir.getString("nmdiagnosaawal"));
                            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                            form.setLocationRelativeTo(internalFrame1);
                            form.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnCetakSuratAntigenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratAntigenActionPerformed
        // TODO add your handling code here:
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data pasien sudah habis...!!!!");
            TNoRw.requestFocus();
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                SuratKeteranganAntigen resume=new SuratKeteranganAntigen(null,false);
                resume.isCek();
                resume.emptTeks();
                resume.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                resume.setLocationRelativeTo(internalFrame1);
                resume.setNoRm(TNoRw.getText(),DTPCari1.getDate(),kddokter.getText(),TDokter.getText());
                resume.tampil();
                resume.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }//GEN-LAST:event_MnCetakSuratAntigenActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakSuratAntigen;
        ...
        if(Sequel.cariRegistrasi(TNoRw.getText())==0){
            try {
                ...
                if(sukses==true){
                    ...
                    sukses=jur.simpanJurnal(TNoRw.getText(),Sequel.cariIsi("select current_date()"),"U","TINDAKAN RAWAT JALAN PASIEN "+TNoRw.getText()+" DIPOSTING OLEH "+akses.getkode());     
                }
