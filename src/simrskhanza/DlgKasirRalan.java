...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            ...
            "Unit","Penanggung Jawab","Alamat P.J.","Hubungan P.J.",
    ...
    private void initComponents() {
        ...
        MnGelang2.setText("Gelang Balita");
        ...
        MnGelang3.setText("Gelang Anak-Anak");
        ...
        MnGelang4.setText("Gelang Dewasa");
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnBuktiPelayananRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBuktiPelayananRalanActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            param.put("kontakrs",akses.getkontakrs());
            param.put("emailrs",akses.getemailrs());
            param.put("sep",Sequel.cariIsi("select no_sep from bridging_sep where no_rawat =?",TNoRw.getText()));
            param.put("faskes",Sequel.cariIsi("select asal_rujukan from bridging_sep where no_rawat =?",TNoRw.getText()));
            param.put("logo",Sequel.cariGambar("select logo from setting"));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabModekasir.getRowCount()==0){
            ...
            Valid.MyReportqry("rptKasirRalan.jasper","report","::[ Data Registrasi Periksa ]::",
                    "select diagnosa_pasien.kd_penyakit, penyakit.nm_penyakit, reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli, reg_periksa.p_jawab,reg_periksa.almt_pj,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur, reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab on reg_periksa.kd_pj=penjab.kd_pj left join diagnosa_pasien on reg_periksa.no_rawat=diagnosa_pasien.no_rawat left join penyakit on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where reg_periksa.status_lanjut='Ralan' and reg_periksa.tgl_registrasi between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' "+
